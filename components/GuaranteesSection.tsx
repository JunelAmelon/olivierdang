...
export default function GuaranteesSection() {
  ...
  const guarantees = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=250&fit=crop&auto=format&q=80",
  ...
  return (
    <section id="guarantees" className="guarantees-section bg-gradient-to-br from-slate-50 via-red-50 to-blue-50 py-16 lg:py-24 relative overflow-hidden">
      {/* Éléments décoratifs */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-aximotravo-blue/10 to-aximotravo-red/10 rounded-full mb-6 border border-aximotravo-blue/20">
            <Shield className="w-5 h-5 text-aximotravo-blue mr-2" />
            <span className="text-aximotravo-red font-semibold text-sm font-architecture">NOS ENGAGEMENTS FORTS</span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight font-architecture mb-6">
            ...
            <span className="bg-gradient-to-r from-aximotravo-red to-aximotravo-blue bg-clip-text text-transparent">exclusives</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {guarantees.map((guarantee, index) => {
            ...
            return (
              ...
              >
                {/* Section Image - SUPPRESSION OVERLAY FLOU */}
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6">
                    <div className={`w-16 h-16 bg-white/90 backdrop-blur-sm border-2 border-${guarantee.color}/60 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                      <IconComponent className={`w-8 h-8 text-${guarantee.color}`} />
                    </div>
                  </div>
                  ...
                  <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm px-3 py-2 rounded-xl shadow-lg">
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-aximotravo-blue" />
                ...
                {/* Section Contenu */}
                <div className="p-6">
                  <h3 className={`text-xl font-bold mb-4 group-hover:scale-105 transition-transform duration-300 font-architecture text-${guarantee.color}`}>
                    {guarantee.title}
                  </h3>
                  ...
                  <div className="mt-6 flex items-center space-x-2">
                    <div className="flex space-x-1">
                      {[...Array(5)].map((_, i) => (
                        <div
                          key={i}
                          className={`w-2 h-2 bg-${guarantee.color} rounded-full transition-all duration-300 ${
                ...
                <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-xl shadow-${guarantee.color}/20`}></div>
              </div>
            );
          })}
        </div>
            ...
            <div>
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <div className="flex text-aximotravo-yellow text-sm">★★★★★</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-aximotravo-blue font-architecture">38</div>
                  <div className="text-sm text-slate-600 font-architecture">Jours de vente</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-aximotravo-red font-architecture">100%</div>
                  <div className="text-sm text-slate-600 font-architecture">Prix souhaité</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-aximotravo-yellow font-architecture">0</div>
