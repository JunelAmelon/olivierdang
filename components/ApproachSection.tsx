...
export default function ApproachSection() {
  ...
  return (
    <section id="approach" className="bg-gradient-to-br from-slate-50 via-red-50 to-blue-50 py-16 lg:py-24 relative overflow-hidden">
      {/* Éléments décoratifs */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-aximotravo-red/10 to-aximotravo-blue/10 rounded-full mb-6 border border-aximotravo-red/20">
            <CheckCircle className="w-5 h-5 text-aximotravo-red mr-2" />
            <span className="text-aximotravo-red font-semibold text-sm font-architecture">NOTRE MÉTHODE EXCLUSIVE</span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight font-architecture mb-6">
            ...
            <span className="bg-gradient-to-r from-aximotravo-red to-aximotravo-blue bg-clip-text text-transparent">exclusive</span>
          </h2>
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div
                ...
                } ${isActive ? `ring-2 ring-${step.color} scale-105` : ''}`}
              ...
              >
                ...
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-b from-${step.color}/30 to-transparent opacity-20 group-hover:opacity-10 transition-opacity duration-300`}></div>
                  
                  {/* Numéro flottant */}
                  <div className="absolute top-4 left-4">
                    <div className={`w-12 h-12 bg-${step.color} rounded-xl flex items-center justify-center shadow-xl font-bold text-white text-lg transition-all duration-300 ${
                      isActive ? 'scale-110' : ''
                    }`}>
                      {step.number}
                    </div>
                ...
                {/* Section Contenu */}
                <div className="p-6">
                  <h3 className={`text-lg font-bold mb-3 group-hover:scale-105 transition-transform duration-300 font-architecture text-${step.color}`}>
                    {step.title}
                  </h3>
                  ...
                  <div className="mt-4 w-full h-1 bg-slate-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full rounded-full transition-all duration-1000 bg-gradient-to-r from-${step.color} to-${step.color}-light`}
                      style={{
                ...
                } shadow-xl shadow-${step.color}/20`}></div>
              </div>
            );
          })}
        </div>
          ...
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                <div className="text-center">
                  <div className="text-4xl font-bold text-aximotravo-red mb-2 font-architecture">3x</div>
                  <p className="text-slate-300 font-architecture">Plus rapide</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-aximotravo-yellow mb-2 font-architecture">+18%</div>
                  <p className="text-slate-300 font-architecture">Plus-value moyenne</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-aximotravo-blue mb-2 font-architecture">99%</div>
