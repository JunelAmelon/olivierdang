...
export default function SalesShowcaseSection() {
  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 via-red-50 to-blue-50 py-16 lg:py-24 relative overflow-hidden">
      {/* Éléments décoratifs */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-aximotravo-red/20 to-aximotravo-blue/20 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-aximotravo-blue/20 to-aximotravo-yellow/20 rounded-full blur-3xl animate-pulse delay-1000"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* En-tête */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-aximotravo-blue/10 to-aximotravo-red/10 rounded-full mb-6 border border-aximotravo-blue/20">
            <CheckCircle className="w-5 h-5 text-aximotravo-blue mr-2" />
            <span className="text-aximotravo-red font-semibold text-sm font-architecture">VENTES RÉUSSIES</span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight font-architecture mb-6">
            ...
            <span className="bg-gradient-to-r from-aximotravo-red to-aximotravo-blue bg-clip-text text-transparent">réussites</span>
            <br />
            <span className="text-slate-900">immobilières</span>
          </h2>
          <p className="text-xl text-slate-600 max-w-4xl mx-auto font-architecture">
            Découvrez comment notre expertise <strong className="text-aximotravo-red">immobilier + travaux</strong> a permis à nos clients
          ...
          {sales.map((sale, index) => {
            ...
            return (
              <div
                ...
                } ${sale.featured ? 'ring-2 ring-aximotravo-yellow/50 scale-105' : ''}`}
                style={{ transitionDelay: `${index * 150}ms` }}
              >
                {/* Badge featured */}
                {sale.featured && (
                  <div className="absolute -top-2 -right-2 z-20">
                    <div className="bg-gradient-to-r from-aximotravo-yellow to-aximotravo-yellow-dark text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg flex items-center">
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  {/* Badge "VENDU" animé */}
                  <div className="absolute top-4 left-4 bg-gradient-to-r from-aximotravo-blue to-aximotravo-blue-dark text-white px-4 py-2 rounded-full text-sm font-bold font-architecture shadow-lg group-hover:scale-110 transition-transform duration-300">
                    ✓ VENDU
                  </div>
                  
                  {/* Badge augmentation */}
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-aximotravo-red to-aximotravo-red-dark text-white px-3 py-2 rounded-full text-sm font-bold font-architecture flex items-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm px-3 py-2 rounded-xl shadow-lg">
                    <div className="flex items-center space-x-2">
                      <Calendar className="w-4 h-4 text-aximotravo-yellow" />
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-slate-900 font-architecture mb-2 group-hover:text-aximotravo-red transition-colors duration-300">
                      {sale.title}
                    </h3>
                    <div className="flex items-center text-slate-600 text-sm font-architecture">
                      <MapPin className="w-4 h-4 mr-1 text-aximotravo-blue" />
                      {sale.location}
                    </div>
                  </div>
                  ...
                  {/* Prix avec animation - PRIX EN JAUNE */}
                  <div className="space-y-3">
                    <div className="flex items-center justify-between bg-red-50 rounded-lg p-3">
                      <span className="text-sm text-aximotravo-red font-architecture">Prix initial :</span>
                      <span className="text-sm text-aximotravo-red line-through font-architecture font-semibold">
                        {formatPrice(sale.originalPrice)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between bg-yellow-50 rounded-lg p-3">
                      <span className="text-sm font-semibold text-aximotravo-yellow font-architecture">Prix de vente :</span>
                      <span className="text-lg font-bold text-aximotravo-yellow font-architecture">
                  ...
                  {/* Plus-value en grand */}
                  <div className="bg-gradient-to-r from-aximotravo-blue to-aximotravo-red rounded-xl p-4 text-center text-white relative overflow-hidden">
                ...
                <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none border-2 border-aximotravo-red/30"></div>
              </div>
            );
          })}
        </div>

        {/* Statistiques globales animées - SUPPRESSION DU VERT */}
        <div className="stats-section mb-16">
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-slate-200 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-aximotravo-red/30 to-aximotravo-blue/30 rounded-bl-full"></div>
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-4 gap-8 text-center">
                <div className="group">
                  <div className="bg-gradient-to-br from-aximotravo-red/10 to-aximotravo-red/20 rounded-2xl p-6 group-hover:scale-105 transition-transform duration-300">
                    <div className="text-4xl font-bold text-aximotravo-red font-architecture mb-2">
                ...
                <div className="group">
                  <div className="bg-gradient-to-br from-aximotravo-blue/10 to-aximotravo-blue/20 rounded-2xl p-6 group-hover:scale-105 transition-transform duration-300">
                    <div className="text-4xl font-bold text-aximotravo-blue font-architecture mb-2">
                ...
                <div className="group">
                  <div className="bg-gradient-to-br from-aximotravo-yellow/10 to-aximotravo-yellow/20 rounded-2xl p-6 group-hover:scale-105 transition-transform duration-300">
                    <div className="text-4xl font-bold text-aximotravo-yellow font-architecture mb-2">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-aximotravo-red/10 to-aximotravo-blue/10"></div>
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  ...
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-aximotravo-red to-aximotravo-red-dark text-white font-bold rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-aximotravo-red/25 transform hover:-translate-y-1 font-architecture"
                >
