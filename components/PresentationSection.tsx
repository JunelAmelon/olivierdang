...
export default function PresentationSection() {
  ...
  return (
    <section className="bg-gradient-to-br from-red-50 to-blue-50 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* En-tête avec badge */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-aximotravo-red to-aximotravo-blue rounded-full mb-6">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight font-architecture mb-8">
            ...
            <span className="text-aximotravo-red">{typingText}</span>
            {showCursor && <span className="text-aximotravo-blue animate-pulse">|</span>}
            <br />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-aximotravo-red to-aximotravo-blue rounded-3xl opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
            <img
            ...
            />
            {/* Badge flottant animé - POINT BLEU AU LIEU DE VERT */}
            <div className="absolute top-6 left-6 bg-white/95 backdrop-blur-sm px-4 py-3 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-aximotravo-blue rounded-full animate-pulse"></div>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                <p className="text-lg text-slate-600 leading-relaxed font-architecture mb-4">
                  <strong className="text-aximotravo-red">Expert en immobilier et Président d'Aximotravo</strong>
                </p>
                <div className="w-full h-1 bg-gradient-to-r from-aximotravo-red to-aximotravo-blue rounded-full mb-4"></div>
              ...
              <div className="space-y-4">
                <p className="text-lg text-slate-600 leading-relaxed font-architecture">
                  Avec plus de <strong className="text-aximotravo-red">10 ans d'expérience</strong> dans l'accompagnement des propriétaires, j'ai développé une méthode unique combinant expertise immobilière et maîtrise des travaux pour valoriser votre bien.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed font-architecture">
                  En tant que Président d'Aximotravo, j'ai accompagné plus de <strong className="text-aximotravo-blue">500 propriétaires</strong> vers une vente réussie, rapide et au meilleur prix. Ma philosophie : des résultats concrets sans stress ni mauvaises surprises.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4 group hover:transform hover:translate-x-2 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-slate-600 font-architecture">
                    Nous vendons <strong className="text-aximotravo-red">3x plus vite</strong> que la moyenne du marché.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 group hover:transform hover:translate-x-2 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-slate-600 font-architecture">
                    Notre expertise travaux permet d'augmenter la valeur de votre bien de <strong className="text-aximotravo-red">+15 à +30%</strong>.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="stats-section" className="grid grid-cols-3 gap-6 pt-8 border-t border-slate-200">
              <div className="text-center group">
                <div className="bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <div className="text-3xl lg:text-4xl font-bold text-aximotravo-red mb-2 font-architecture">
                    {yearsCount}+
                  </div>
              ...
              <div className="text-center group">
                <div className="bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <div className="text-3xl lg:text-4xl font-bold text-aximotravo-blue mb-2 font-architecture">
                    {clientsCount}+
                  </div>
                  <p className="text-slate-600 font-medium text-sm lg:text-base font-architecture">
              ...
              <div className="text-center group">
                <div className="bg-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <div className="text-3xl lg:text-4xl font-bold text-aximotravo-yellow mb-2 font-architecture">
                    {satisfactionCount}%
                  </div>
                  <p className="text-slate-600 font-medium text-sm lg:text-base font-architecture">
            ...
            <div className="pt-6">
              <a
                href="/contact"
                className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-aximotravo-red to-aximotravo-blue text-white font-bold rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-aximotravo-red/25 transform hover:-translate-y-1 font-architecture"
              >
