...
export default function HeroSection() {
  ...
  return (
    <>
      <section className="relative bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-16 lg:py-24 overflow-hidden min-h-screen flex items-center">
        {/* Éléments décoratifs animés */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-[#7384bc]/10 to-[#fd733f]/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-[#fd733f]/10 to-green-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8 lg:pr-8">
              ...
              <div className="space-y-6">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight font-architecture">
                  ...
                  <span className="bg-gradient-to-r from-[#7384bc] to-[#fd733f] bg-clip-text text-transparent block animate-fadeInUp delay-400">
                    sans stress.
                  </span>
                </h1>
                
                {/* Titre dynamique du slide actuel */}
                <div className="p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border-l-4 border-gradient-to-b from-[#7384bc] to-[#fd733f]">
                ...
                <p className="text-xl text-slate-600 leading-relaxed max-w-2xl font-architecture animate-fadeInUp delay-600">
                  Grâce à notre <strong className="text-[#7384bc]">double expertise immobilier + travaux</strong>, 
                  nous transformons votre bien en une opportunité irrésistible pour les acheteurs.
                  <br /><br />
                  <span className="text-[#fd733f] font-semibold">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fadeInUp delay-800">
               ...
               className="group px-8 py-4 bg-gradient-to-r from-[#fd733f] to-[#e5652e] text-white font-bold rounded-xl transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-2 flex items-center justify-center space-x-2 font-architecture relative overflow-hidden"
               >
          ...
          >
          <div className="w-12 h-12 bg-gradient-to-r from-slate-100 to-slate-200 rounded-full flex items-center justify-center shadow-md group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
          ...
          <span>Voir comment ça marche</span>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8 animate-fadeInUp delay-1000">
                <div className="text-center group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-slate-200/50">
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[#7384bc] to-green-500 bg-clip-text text-transparent font-architecture">
                        {satisfactionCount}%
                      </span>
                    </div>
                ...
                <div className="text-center group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-slate-200/50">
                    <div className="flex items-center justify-center mb-2">
                      <div className="w-3 h-3 bg-[#fd733f] rounded-full mr-2 animate-pulse"></div>
                      <span className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[#fd733f] to-[#e5652e] bg-clip-text text-transparent font-architecture">
                        {salesCount}+
                      </span>
                    </div>
                ...
                <div className="text-center group">
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-slate-200/50">
                    <div className="flex items-center justify-center mb-2">
                      <div className="w-3 h-3 bg-[#7384bc] rounded-full mr-2 animate-pulse"></div>
                      <span className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[#7384bc] to-purple-500 bg-clip-text text-transparent font-architecture">
                        {experienceCount}+
                      </span>
                    </div>
            ...
            <div className="relative lg:pl-8">
              <div className="relative h-[500px] lg:h-[650px] rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute top-6 right-6 bg-gradient-to-r from-[#7384bc] to-[#fd733f] text-white px-4 py-3 rounded-xl shadow-lg font-architecture animate-fadeInRight">
                ...
                <div className="absolute bottom-6 right-6 bg-[#fd733f] text-white px-6 py-4 rounded-xl shadow-lg font-architecture animate-pulse">
                  <div className="text-center">
