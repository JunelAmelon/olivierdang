                  ...
                  <div className="pt-6 sm:pt-8 border-t border-white/20">
                    <div className="flex space-x-3 sm:space-x-4">
                      ...
                      <a
                        ...
                        className="w-9 h-9 sm:w-10 sm:h-10 bg-white/20 rounded-lg flex items-center justify-center hover:bg-white/30 transition-colors"
              ...
              <div className="lg:col-span-3 p-6 sm:p-8 lg:p-12">
                <div className="max-w-2xl mx-auto">
                  <div className="mb-6 sm:mb-8">
                    <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-3 sm:mb-4 font-architecture">
                  ...
                  {isSubmitted ? (
                    <div className="text-center py-8 sm:py-12">
                      ...
                      <p className="text-slate-600 font-architecture mb-4 sm:mb-6 text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-slate-600 font-architecture">
          ...
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl max-w-xs sm:max-w-sm">
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 font-architecture mb-1 text-sm sm:text-base">Notre bureau</h3>
                  <p className="text-xs sm:text-sm text-slate-600 font-architecture mb-2">
                    123 Avenue des Champs-Élysées<br />
                    75008 Paris, France
                  </p>
